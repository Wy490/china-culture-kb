    ...
    it('combines generated health and production readiness into MVP lanes', async () => {
      ...
      expect(res.body.data).toMatchObject({
        ...
        summary: expect.objectContaining({
          ...
          domain_pack_expansion_review_approved_count: 34,
          domain_pack_expansion_review_rejected_count: 0,
          domain_pack_expansion_review_needs_revision_count: 0,
          domain_pack_expansion_approved_writeback_draft_count: 34,
          domain_pack_expansion_writeback_draft_ready_count: 34,
          ...
          domain_pack_expansion_development_progress_average_percent: 68,
          domain_pack_expansion_field_workbench_controls_percent: 82,
          domain_pack_expansion_manual_review_closure_percent: 65,
          domain_pack_expansion_writeback_safety_export_percent: 75,
          domain_pack_expansion_second_batch_real_candidates_percent: 50,
          domain_pack_expansion_mvp_completion_surface_percent: 70,
      ...
      expect(res.body.data.markdown).toContain('domain pack expansion review approved: 34');
      expect(res.body.data.markdown).toContain('domain pack expansion approved writeback drafts: 34');
      expect(res.body.data.markdown).toContain('domain pack expansion writeback preflight ready: true');
      expect(res.body.data.markdown).toContain('domain pack expansion manual writeback required: 34');
      ...
      expect(res.body.data.progress.find((slice: any) => slice.key === 'content_command_layer')?.evidence).toEqual(expect.arrayContaining([
        ...
        'domain_pack_expansion_review_approved=34',
        'domain_pack_expansion_approved_writeback_drafts=34',
        ...
        'domain_pack_expansion_manual_writeback_required=34',
        'domain_pack_expansion_next_development_tasks=5',
        'domain_pack_expansion_plan_1_field_workbench_controls_percent=82',
        'domain_pack_expansion_plan_2_manual_review_closure_percent=65',
        'domain_pack_expansion_plan_3_writeback_safety_export_percent=75',
        'domain_pack_expansion_plan_4_second_batch_real_candidates_percent=50',
        'domain_pack_expansion_plan_5_mvp_completion_surface_percent=70',
