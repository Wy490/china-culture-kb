    ...
    it('exposes a bounded ops summary from the canonical detailed report', async () => {
      ...
      await writeJsonFixture(reportDir, 'report.json', {
        ...
        coverage: {
          ...
          unique_character_label_count: 10,
          unique_location_label_count: 8,
          unique_content_sha256_count: 16,
          cross_case_content_reuse_count: 0,
          semantic_gate_passed_case_count: 8,
          source_content_sha256_verified_asset_count: 34,
          media_signature_verified_asset_count: 34,
          immutable_preview_verified_asset_count: 34,
          identity_mapping_current_asset_count: 34,
        },
        scenario_summary: {
          required_count: 6,
          passed_count: 6,
