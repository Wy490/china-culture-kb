...
const AI_COMIC_NARRATIVE_SUBJECT_RULES: NarrativePatternSubjectRule[] = [
  ...
  },
  {
    ...
    patterns: ['platform_short_drama_hook', 'hero_choice', 'cinematic_setpiece_adaptation'],
    signals: ['历史人物', '人物', '名臣', '诗人', '将军', '思想家', '成长', '抉择', '仕途', '功业'],
    reason: '素材是人物或历史人物线索，优先把关键选择、外部压力和高光场面变成可分镜冲突。',
    confidence: 0.82,
  },
];
...
const GENRE_MATRIX_DEFAULTS: Record<VideoType, GenreStoryMatrixFields> = {
  character_story: matrix({
    ...
    recommended_narrative_patterns: ['hero_choice', 'historical_causal_story'],
  ...
  historical_drama: matrix({
    ...
    recommended_narrative_patterns: ['historical_causal_story', 'hero_choice'],
  ...
  heritage_promo: matrix({
    ...
    default_truth_mode: 'factual_reconstruction',
    recommended_narrative_patterns: ['craft_mastery'],
    allowed_narrative_patterns: uniquePatternIds([...PROMO_PATTERNS, ...DOCUMENTARY_PATTERNS, ...EDUCATION_PATTERNS]),
  ...
  documentary_short: matrix({
    ...
    default_truth_mode: 'factual_reconstruction',
    recommended_narrative_patterns: ['documentary_investigation', 'object_clue_journey'],
  ...
  ai_comic_drama: matrix({
    ...
    recommended_narrative_patterns: ['platform_short_drama_hook', 'hero_choice', 'cinematic_setpiece_adaptation'],
