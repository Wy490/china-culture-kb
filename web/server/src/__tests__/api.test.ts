  ...
  describe('GET /api/system/domain-pack-expansion-candidates', () => {
    it('returns review-gated Domain Pack expansion candidate batches', async () => {
      ...
      expect(res.body.data).toMatchObject({
        ...
        writeback_preflight: {
          ...
          approved_draft_count: 58,
          draft_ready_count: 58,
          target_file_count: 3,
    ...
    it('bulk updates filtered expansion review state without writing provinces', async () => {
      ...
      expect(bulkRes.body.data).toMatchObject({
        ...
        report: {
          review_packet: {
            approved_writeback_draft_count: 58,
          },
        },
      });
    ...
    it('combines generated health and production readiness into MVP lanes', async () => {
      ...
      expect(res.body.data).toMatchObject({
        ...
        summary: expect.objectContaining({
          ...
          domain_pack_expansion_review_approved_count: 58,
          domain_pack_expansion_review_rejected_count: 0,
          domain_pack_expansion_review_needs_revision_count: 0,
          domain_pack_expansion_approved_writeback_draft_count: 58,
          domain_pack_expansion_writeback_draft_ready_count: 58,
          ...
          domain_pack_expansion_development_progress_average_percent: 94,
          domain_pack_expansion_field_workbench_controls_percent: 96,
          domain_pack_expansion_manual_review_closure_percent: 91,
          domain_pack_expansion_writeback_safety_export_percent: 98,
          domain_pack_expansion_second_batch_real_candidates_percent: 92,
          domain_pack_expansion_mvp_completion_surface_percent: 94,
      ...
      expect(res.body.data.markdown).toContain('domain pack expansion review approved: 58');
      expect(res.body.data.markdown).toContain('domain pack expansion approved writeback drafts: 58');
      ...
      expect(res.body.data.markdown).toContain('domain pack expansion manual writeback required: 58');
      ...
      expect(res.body.data.progress.find((slice: any) => slice.key === 'content_command_layer')?.evidence).toEqual(expect.arrayContaining([
        ...
        'domain_pack_expansion_review_approved=58',
        'domain_pack_expansion_approved_writeback_drafts=58',
        ...
        'domain_pack_expansion_manual_writeback_required=58',
        'domain_pack_expansion_next_development_tasks=5',
        'domain_pack_expansion_plan_1_field_workbench_controls_percent=96',
        'domain_pack_expansion_plan_2_manual_review_closure_percent=91',
        'domain_pack_expansion_plan_3_writeback_safety_export_percent=98',
        'domain_pack_expansion_plan_4_second_batch_real_candidates_percent=92',
        'domain_pack_expansion_plan_5_mvp_completion_surface_percent=94',
      ...
      expect(res.body.data.lanes).toEqual(expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          evidence: expect.arrayContaining([
            ...
            'review_approved_count=58',
            'approved_writeback_drafts=58',
            'writeback_queued=0',
            'writeback_preflight_ready=true',
            'writeback_preflight_target_files=3',
            'manual_writeback_required=58',
