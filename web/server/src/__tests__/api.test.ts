    ...
    it('exposes a bounded ops summary from the canonical detailed report', async () => {
      ...
      await writeJsonFixture(reportDir, 'report.json', {
        ...
        coverage: {
          ...
          unique_style_family_count: 12,
          unique_character_label_count: 14,
          unique_location_label_count: 12,
          unique_content_sha256_count: 24,
          cross_case_content_reuse_count: 0,
          semantic_gate_passed_case_count: 12,
          source_content_sha256_verified_asset_count: 50,
          media_signature_verified_asset_count: 50,
          immutable_preview_verified_asset_count: 50,
          identity_mapping_current_asset_count: 50,
        },
        scenario_summary: {
          required_count: 6,
          passed_count: 6,
    ...
    it('combines generated health and production readiness into MVP lanes', async () => {
      ...
      expect(res.body.data).toMatchObject({
        ...
        performance: {
          ...
          production_material_pack_ms: expect.any(Number),
          domain_pack_ms: expect.any(Number),
          domain_pack_expansion_ms: expect.any(Number),
          knowledge_writeback_ms: expect.any(Number),
