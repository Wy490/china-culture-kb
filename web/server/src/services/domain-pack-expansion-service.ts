...
function buildNextDevelopmentTasks(
  ...
  return [
    ...
    },
    {
      ...
      status: 'ready',
      progress_percent: 96,
      progress_note: '当前 62 条已形成 approved 草案；本轮补入湘西苗族银饰、秋收起义、橘子洲和巴陵戏候选，覆盖 heritage_promo/documentary_short/ai_comic_drama/explainer_video。',
    ...
    },
    {
      ...
      progress_percent: 99,
      progress_note: 'MVP 已接入扩库 complete、62 条写回草案计数、复核交接签收 manifest/canonical signoff package、复核人身份覆盖率、审签批次归档、批次 ready/blocked 汇总、下载归档证据、runtime 覆盖证据和 1-5 项百分比；继续强调“完成候选但待人工写回”。',
