...
- Production Board / GEARS / Seedance 交付链：约 60%
- AI 漫剧系列生产链：约 45%
- 可商用制作中台：约 35-40%
...
- Production Board 修复包必须支持单任务修复入口，并在修复结果区展示交付阶段、阻断项、监督分、QA 分和剩余任务的前后 diff；更细的逐场景 diff 后续再按需展开。
